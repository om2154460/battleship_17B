...
//Constructor, takes a string pointer to positioning coordinates
Ship::Ship(int length, string * positioning){
...
//Constructor, takes a vector<string> filled with positioning coordinates
Ship::Ship(int length, vector<string> positioning){
    //Set Ship size equal to length parameter
    size = length;
    //Set ship health equal to the size of the ship
    health = size;
...
string Ship::setHit(string coordinate){
...
//Set the ship size and coordiantes using a integer length and string pointer to the coordinates.
void Ship::createShip(int length, string * positioning){
    //Set Ship size equal to length parameter
    size = length;
    //Set ship health equal to the size of the ship
    health = size;
...
//Set the ship size and coordiantes using a integer length and string pointer to the coordinates.
void Ship::createShip(int length, vector<string> positioning){
    //Set Ship size equal to length parameter
    size = length;
    //Set ship health equal to the size of the ship
    health = size;
...
//Set the ship size and coordiantes using a vector<string> and its size function
void Ship::createShip(vector<string> positioning){
    //Set Ship size equal to length parameter
